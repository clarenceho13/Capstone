import {
  require_warning
} from "./chunk-3JXFQHXA.js";
import {
  NavItem_default,
  NavLink_default,
  Nav_default
} from "./chunk-E7FOTRYZ.js";
import {
  NavContext_default,
  TabContext_default,
  useForceUpdate
} from "./chunk-GKCHFXDR.js";
import {
  Anchor_default,
  useCallbackRef,
  useEventListener
...
} from "./chunk-BRVE4QXU.js";
import {
  NavbarContext_default
} from "./chunk-SPYSTYP7.js";
import {
...
var FormSelect = React37.forwardRef(({
  ...
  return (0, import_jsx_runtime37.jsx)("select", {
    ...
    size: htmlSize,
    ref,
    className: (0, import_classnames24.default)(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id || controlId
  });
});
...
var Modal = React47.forwardRef(({
  ...
  const renderBackdrop = (0, import_react30.useCallback)((backdropProps) => (0, import_jsx_runtime48.jsx)("div", {
    ...backdropProps,
...
var Overlay = React49.forwardRef((props, outerRef) => {
  ...
  if (Transition) {
    ...
    child = (0, import_jsx_runtime51.jsx)(Transition, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime57.jsxs)(import_jsx_runtime56.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react35.cloneElement)(children, triggerProps), (0, import_jsx_runtime55.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime76.jsxs)(Tabs_default, {
    ...
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime75.jsx)(Nav_default, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
...
//# sourceMappingURL=chunk-WHPXILLS.js.map
