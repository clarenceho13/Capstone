import {
  ...
  useWillUnmount,
  useWindow
} from "./chunk-NB2XQCM7.js";
import {
  Container_default
} from "./chunk-FAY5UGLS.js";
import {
  DEFAULT_BREAKPOINTS,
...
var Button = React9.forwardRef((_ref, ref) => {
  let {
    as: asProp,
    disabled
...
Button2.defaultProps = defaultProps5;
...
function useTimeout() {
  ...
  var handleRef = (0, import_react16.useRef)();
...
function useForceUpdate() {
  var _useReducer = (0, import_react18.useReducer)(function(state) {
    return !state;
...
function useSafeState(state) {
  var isMounted = useMounted();
  return [state[0], (0, import_react19.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
var $704cf1d3b684cc5c$var$SSRContext = (0, import_react23.default).createContext($704cf1d3b684cc5c$var$defaultContext);
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  let cur = (0, import_react23.useContext)($704cf1d3b684cc5c$var$SSRContext);
  ...
  return (0, import_react23.default).createElement($704cf1d3b684cc5c$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
function $704cf1d3b684cc5c$export$619500959fc48b26(defaultId) {
  let ctx = (0, import_react23.useContext)($704cf1d3b684cc5c$var$SSRContext);
  if (ctx === $704cf1d3b684cc5c$var$defaultContext && !$704cf1d3b684cc5c$var$canUseDOM)
    console.warn("When server rendering, you must wrap your application in an <SSRProvider> to ensure consistent ids are generated between the client and server.");
  return (0, import_react23.useMemo)(() => defaultId || `react-aria${ctx.prefix}-${++ctx.current}`, [
    defaultId
  ]);
}
...
var Switch = React50.forwardRef((props, ref) => (0, import_jsx_runtime49.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Overlay = React67.forwardRef((props, outerRef) => {
  ...
  if (Transition) {
    ...
    child = (0, import_jsx_runtime67.jsx)(Transition, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime73.jsxs)(import_jsx_runtime72.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react48.cloneElement)(children, triggerProps), (0, import_jsx_runtime71.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React72.forwardRef(({
    children,
    ...props
...
var ToastFade = React89.forwardRef((props, ref) => (0, import_jsx_runtime95.jsx)(Fade_default, {
  ...props,
  ref,
